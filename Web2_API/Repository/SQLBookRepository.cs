...
namespace Web2_API.Repository
{
    public class SQLBookRepository : IBookRepository
    {
        ...
        public AddBookRequestDTO? UpdateBookById(int id, AddBookRequestDTO bookDTO)
        {
            ...
            var existingAuthorDomain = _dbContext.Book_Authors.Where(a => a.BookId == id).ToList();
            if (existingAuthorDomain.Any())
            {
                _dbContext.Book_Authors.RemoveRange(existingAuthorDomain);
            }
